...
class TestUserLogin(TestCase):
    def setUp(self):
        ...
        self.user = HustlrUsers.objects.create_user(
...
def test_registration_and_response(test_api):
    ...
    ), f"Expected 201 but got {resp.status_code}. Errors: {resp.data}"
...
def test_login_and_response(test_api):
    user = HustlrUsers.objects.create_user(
        email="jabbar@gmail.com", password="jabs@123"
    )
    ...
    data = {"email": "jabbar@gmail.com", "password": "jabs@123"}
